...
import time
path = f'{pathlib.Path(__file__).parent.absolute()}'.replace("\\","/")
path2 = path + "/" + "ADB"
escolha1 = input('''
1 - Personagem
2 - Skate (Custom)
...
if escolha1 == '1':
    ...
    if escolha2 == '27':
        ...
        file_path = "C:/Users/DESKTOP_BRY/OneDrive/Área de Trabalho/Python/SubwaySurfers/Custom/characters_inventory.json"
    ...
    file_path = "C:/Users/DESKTOP_BRY/OneDrive/Área de Trabalho/Python/SubwaySurfers/Custom/boards_inventory.json"
